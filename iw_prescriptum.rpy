...
label iw_prescriptum:
    ...
    "Я из последних сил напряг зрение."
    "Покрутил головой…{w} ни пляжа, ни леса, ни девочек…"
    "Ни луны, ни звёзд, ни даже моего тела."
    sv "И при чём тут какие-то девочки, интересно?"
    "Из сумрака, с ветки раскинувшегося рядом клёна на меня таращились два ярко-жёлтых глаза с узкими вертикальными зрачками."
    ...
    "Откуда-то выпрыгнула услышанная недавно фраза и с размаху ударила меня словно свинцовый кирпич…"
    window hide
    ...
    "И почему бы не подыграть своим галлюцинациям и не совместить это с поездкой на…{w=2} каком там…{w=1} автобусе."
